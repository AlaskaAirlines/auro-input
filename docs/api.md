...
| `customValidityTypeEmail`    | `customValidityTypeEmail`    | `String`  | "Please enter a valid email address (name@domain.com)." | Help text message to display when type = `email` and invalid email is entered; |
